codeunit 50054 "Req. Wksh.-Make Order-New"
{
    ...
    begin
        with ReqLine2 do begin
            ...
            PurchOrderHeader."Receiving No. Series" := 'P-RCPT';
    ...
    UpdateAddressDetails: Boolean) Result: Boolean
    begin
        with RequisitionLine do Result := (PurchOrderHeader."Buy-from Vendor No." <> "Vendor No.") or (PurchOrderHeader."Sell-to Customer No." <> "Sell-to Customer No.") or (PrevShipToCode <> "Ship-to Code") or (PurchOrderHeader."Order Address Code" <> "Order Address Code") or (PurchOrderHeader."Currency Code" <> "Currency Code") or (PrevPurchCode <> "Purchasing Code") or (PrevLocationCode <> "Location Code") or CheckAddressDetails("Sales Order No.", "Sales Order Line No.", UpdateAddressDetails);
    end;
