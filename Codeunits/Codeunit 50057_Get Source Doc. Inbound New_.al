codeunit 50057 "Get Source Doc. Inbound New"
{
    trigger OnRun()
    begin
    end;
    ...
    var
        GetSourceDocuments: Report "Get Source DocumentsNew";
    ...
    procedure GetSingleWhsePutAwayDoc(CurrentWkshTemplateName: Code[10];
    ...
    begin
        ...
        if WhsePutAwayDocSelection.RunModal <> ACTION::LookupOK then exit;
        WhsePutAwayDocSelection.GetResult(WhsePutAwayRqst);
        GetWhseSourceDocuments.SetWhseWkshName(CurrentWkshTemplateName, CurrentWkshName, LocationCode);
    ...
    begin
        if WhseRqst.FindSet then begin
            repeat
                if Location.RequireReceive(WhseRqst."Location Code") then LocationCode += WhseRqst."Location Code" + '|';
    ...
    local procedure FindWarehouseRequestForPurchaseOrder(var WhseRqst: Record "Warehouse Request";
    ...
    local procedure FindWarehouseRequestForSalesReturnOrder(var WhseRqst: Record "Warehouse Request";
    ...
    local procedure FindWarehouseRequestForInbndTransferOrder(var WhseRqst: Record "Warehouse Request";
    ...
    begin
        ...
        if WhseReceiptCreated then OpenWarehouseReceiptPage;
    end;
